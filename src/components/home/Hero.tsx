    ...
    <div className="hero-section">
      <div className="container-custom flex flex-col items-center text-center">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-fade-in">
          Conectando Cuidado com Compaixão
        </h1>
        <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl animate-fade-in">
          Serviços de cuidados profissionais adaptados às suas necessidades.
          Conectamos cuidadores qualificados com aqueles que precisam de assistência.
        </p>
